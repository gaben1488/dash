...
export const SIGNAL_LABELS: Readonly<Record<string, string>> = {
  ...
  epFactDeviation: 'По ЕП факт не равен плану',
  ...
  // законная стадия «Закупки, проводимые в течение года», а не ошибка. Подпись
  // называет стадию, бейдж «есть факт» на таких строках неверен.
  factWithoutDate: 'Закупка, проводимая в течение года',
  dateWithoutFact: 'Факт дата без сумм',
  // Канон п.23: имя класса — «не обеспеченная финансированием» (P пуст).
  planYearMissing: 'Не обеспечено финансированием',
  ...
  derivedFormulaBroken: 'Сломана формула даты',
...
export const METRIC_LABELS: Readonly<Record<string, string>> = {
  ...
  remainder_to_conclude: 'Остаток к заключению',
