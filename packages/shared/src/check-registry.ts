...
export const CHECK_REGISTRY: CheckRegistryEntry[] = [
  ...
  // чтение (legacy-конвертер удалён 14.08.2026 как невызываемый).
  {
    ...
    recommendation: 'Разобрать судьбу строки: финансирование подтверждено — проставить сроки (N, O, P); деньги перераспределены или закупка не состоится — обнулить план либо пометить отменённой.',
  ...
  },
  {
    ...
    recommendation: 'Проставить плановый квартал (O) по плановой дате N или по дате факта. После этого строка войдёт в печатный год, и расхождение годовых чисел исчезнет.',
    trustComponent: 'data_quality',
    sourceType: 'new',
  },
  {
