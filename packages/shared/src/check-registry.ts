...
export const CHECK_REGISTRY: CheckRegistryEntry[] = [
  ...
  // чтение (legacy-конвертер удалён 14.08.2026 как невызываемый).
  {
    ...
    description: 'Способ и плановые деньги есть, а рукописной плановой даты (N) нет — и производный год (P) пуст вслед за ней: сроки не проставлены, закупка не обеспечена финансированием. Формулы листа СВОД считают год строго и строку не видят: официальный лимит занижен ровно на её сумму. Смотреть на N: P — вторичная история, она считается формулой от N (канон 20.08.2026).',
    severity: 'warning',
    origin: 'bi_heuristic',
    scope: 'department',
  ...
  // ================================================================
  {
    ...
    description: 'Два случая: (а) AD="экономия", но факт ≥ план — некорректный флаг; (б) экономия от 15 до 25 %, но финансовый орган не определил флаг экономии в столбце AD.',
    severity: 'warning',
    origin: 'bi_heuristic',
    scope: 'department',
    kbHint: 'Случай А: AD="экономия" но факт ≥ план (некорректный флаг). Случай Б: экономия от 15 до 25 % без решения органа по флагу (AD пуст). Выше 25 % это же замечание не повторяется: там строку описывает «Высокая экономия свыше 25 %», а незаполненный флаг — правило «Статус (AD) на строках данных».',
