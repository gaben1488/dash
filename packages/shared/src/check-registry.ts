...
export const CHECK_REGISTRY: CheckRegistryEntry[] = [
  ...
  },
  {
    ...
    group: 'data_integrity',
    name: 'Счётная строка без года плана',
    description: 'Способ и плановые деньги есть, а год плана (P) пуст. Наш расчёт относит строку к отчётному году, формулы листа СВОД считают год строго и строку не видят — официальный лимит занижен ровно на её сумму.',
    severity: 'warning',
    origin: 'bi_heuristic',
    scope: 'department',
    kbHint: 'Найдено 06.08.2026 сверкой лимита УЭР: пять строк без года на 589,93 тыс. руб. давали расхождение лимита 13 921 (расчёт) против 13 331 (лист СВОД). Пока год не проставлен, строка невидима для официальных формул.',
    recommendation: 'Проставить год в колонке P «Год (план)». После этого лимит листа СВОД и расчёт продукта сойдутся.',
    trustComponent: 'data_quality',
    sourceType: 'new',
  },
  {
