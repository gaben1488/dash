 ...
 *
 * Структура столбцов:
 * Имена столбцов — как в шапке листа после переименования владельцем
 * 18.08.2026 (канон имён: svod-sheet-names.ts; расчёты не менялись).
 *   D  — ПЛАН, единиц            H  — ФБ план     L  — ФБ факт     U — Экономия
 *   E  — ФАКТ, единиц            I  — КБ план     M  — КБ факт
 *   F  — Отклонение, единиц      J  — МБ план     N  — МБ факт     R — Экономия ФБ
 *   G  — Заключено, %            K  — Итого план   O  — Итого факт   S — Экономия КБ
 *                                  P  — Отклонение, тыс. руб  T — Экономия МБ
 *                                  Q  — Законтрактовано, %    U — Экономия итого
 *
 * Все суммы в тыс. руб.
 */
