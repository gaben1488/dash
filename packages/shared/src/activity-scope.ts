...
/**
 * Маркеры «нет программы» в графе программы (столбец D = индекс 3 =
 * DEPT_COLUMNS.PROGRAM_NAME, «Наименование программы»). X/Х/пусто = без программы
 * (сверено по листу + данным: УЭР/УО ТД-строки D='Х'/'X'). Метки column-map.ts
 * приведены к канону (PROGRAM_NAME=3, SUBPROGRAM=4).
 */
