// ── Страница «Контроль»: пять вкладок — сверка, доверие, замечания,
//    рекомендации, журнал.
//
...
const TABS: { id: QualityTab; label: string; icon: typeof ShieldCheck; description: string }[] = [
  ...
  { id: 'trust', label: 'Доверие', icon: ShieldCheck, description: 'Насколько можно верить числам на экране: индекс надёжности данных' },
