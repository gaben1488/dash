...
import {
  ...
  maskSecret, parseRefreshPassport, parseSourcesResponse, shortId, summarizeDiagnostics,
  timeAgo,
 ...
 * диагностики) переехали в Settings.logic.ts 18.08.2026 — REFACTOR_BACKLOG
 * §G, разрез файлов-гигантов. Здесь осталась разметка и состояние экрана;
 * поведение при переносе не менялось, набор Settings.logic.test.ts тот же.
 */
/**
